...
<head>
    ...
    <style>
        ...
        .status-badge { display: inline-block; background: #ffc107; color: #856404; padding: 5px 15px; border-radius: 20px; font-weight: bold; font-size: 14px; }
        .info-box { background: #d1ecf1; border: 1px solid #bee5eb; border-radius: 8px; padding: 15px; margin: 20px 0; color: #0c5460; }
    </style>
</head>
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="panel">
                ...
                <p><strong>{{ __('Total Paid') }}:</strong> Rp {{ number_format($booking->total_price, 0, ',', '.') }}</p>
