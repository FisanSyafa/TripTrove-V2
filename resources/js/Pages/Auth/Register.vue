    ...
    <div class="min-h-screen flex">
                ...
                <div class="max-w-md text-center">
                    ...
                    <div class="space-y-4 text-left">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-300">{{ __('Easy Booking Process') }}</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-brand-cyan/20 flex items-center justify-center">
                                <svg class="w-5 h-5 text-brand-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-300">{{ __('Exclusive Deals & Offers') }}</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-brand-cyan/20 flex items-center justify-center">
                                <svg class="w-5 h-5 text-brand-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-300">{{ __('24/7 Customer Support') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
            <div class="w-full max-w-md">
                ...
                <!-- Welcome Text -->
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">{{ __('Create an account') }}</h2>
                    <p class="text-gray-600">{{ __('Join us and start exploring the world') }}</p>
                </div>

                <!-- Register Form -->
                <form @submit.prevent="submit" class="space-y-5">
                    <div>
                        <InputLabel for="name" :value="__('Name')" class="text-gray-700 font-semibold" />
                        <TextInput
                            id="name"
                            type="text"
                    ...
                    <div>
                        <InputLabel for="password_confirmation" :value="__('Confirm Password')" class="text-gray-700 font-semibold" />
                        <TextInput
                ...
                <p class="mt-8 text-center text-sm text-gray-600">
                    ...
                    <Link :href="route('login')" class="font-semibold text-brand-blue hover:text-brand-cyan">
                        {{ __('Login') }}
                    </Link>
                </p>
