...
const copyReviewLink = (slug) => {
    const url = route('packages.review', slug);
                ...
                <tbody>
                    ...
                    <tr v-for="pkg in packages.data" :key="pkg.id" class="border-b border-gray-700 hover:bg-gray-700/30 transition-colors duration-150">
                        ...
                        <td class="p-4 text-right whitespace-nowrap space-x-3">
                            <button @click="copyReviewLink(pkg.slug)" class="text-brand-cyan hover:text-brand-blue font-medium transition-colors" title="Salin Link Review">
